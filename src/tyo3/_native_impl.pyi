...
class TyProject:
    ...
    def semantic_tokens(self, path: str, *, start_line: int | None = None, start_col: int | None = None, end_line: int | None = None, end_col: int | None = None) -> Any: ...
    ...
    def code_actions(self, path: str, start_line: int, start_col: int, end_line: int, end_col: int, diagnostic_id: str) -> Any: ...

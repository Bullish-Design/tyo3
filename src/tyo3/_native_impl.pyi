...
class TyProject:
    ...
    def author(self, layer: str, durable_id: str, value: str) -> Any: ...
    def register_authored_layer(self, name: str, spec: Any) -> None: ...
    def config_json(self) -> str: ...
    def full_code_delta(self) -> Any: ...
    def gc(self) -> Any: ...
    def _inject_changes(self, changes: list[tuple[str, str]]) -> None: ...
    def _fault_inject(self, stage: str) -> None: ...
...
class TySnapshot:
    ...
    def needs_review(self) -> list[str]: ...
    def orphaned(self) -> list[str]: ...
    def authored(self, layer: str, id: str) -> Any: ...
    def authored_history(self, layer: str, id: str) -> Any: ...
    def full_code_delta(self) -> Any: ...
    def close(self) -> None: ...
